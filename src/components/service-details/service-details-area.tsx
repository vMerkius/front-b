...
const ServiceDetailsArea = () => {
  ...
  return (
    <>
    <section className="services__details-area section-pt-120 section-pb-120" style={{backgroundImage:`url(/assets/img/bg/team_details_bg.jpg)`}}>
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="team__details-inner-img">
                                        <img src="/assets/img/others/services_details01.jpg" alt="img"/>
                                    </div>
                                </div>
                                <div className="col-sm-6">
                                    <div className="team__details-inner-img">
                                        <img src="/assets/img/others/services_details02.jpg" alt="img"/>
                                    </div>
                                </div>
                            </div>
                        </div>
