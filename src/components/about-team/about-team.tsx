    ...
    <section className="about-team">
      ...
      <div className="about-team__content">
        ...
        <p className="about-team__text">
          At BoostersDEN, we’re a close-knit group of friends with over 10 years
          of gaming experience. We offer expert Boosting and Coaching Services
          for League of Legends, Teamfight Tactics, and Valorant. Every service
          ...
          <span className="about-team__text--trust">
            trust BoostersDEN – trust a team of friends.
          </span>
        </p>
      </div>
    </section>
